...
<!-- 示例：每个功能都从独立库开始；库必须是自包含的、可独立测试的、有文档的；目的明确——禁止仅用于组织架构的库 -->
...
<!-- 示例：文本 I/O 确保可调试性；要求结构化日志记录；或：MAJOR.MINOR.BUILD 格式；或：保持简单，遵循 YAGNI 原则 -->
...
## 治理
<!-- 示例：宪章优于所有其他实践；修正案需要文档记录、审批和迁移计划 -->
